...
/* Gecomponeerd stilleven voor de hero — een plint met meerdere objecten */
function heroScene(){
  const P = PALETTE;
  return `<svg viewBox="0 0 560 620" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Stilleven met interieuraccessoires">
    <!-- achtergrond boog -->
    <path d="M120 40 Q280 -40 440 40 L440 470 L120 470 Z" fill="${P.creamL}" opacity=".7"/>
    <line x1="120" y1="40" x2="120" y2="470" stroke="${P.bronze}" stroke-width="1" opacity=".5"/>
    <line x1="440" y1="40" x2="440" y2="470" stroke="${P.bronze}" stroke-width="1" opacity=".5"/>
    <!-- plint / tafelblad -->
    <rect x="70" y="470" width="420" height="14" fill="${P.ink}"/>
    <rect x="70" y="484" width="420" height="70" fill="${P.clay}" opacity=".55"/>
    <!-- schaduwen -->
    <ellipse cx="200" cy="470" rx="70" ry="10" fill="${P.shade}"/>
    <ellipse cx="350" cy="470" rx="60" ry="9" fill="${P.shade}"/>
    <ellipse cx="430" cy="470" rx="30" ry="6" fill="${P.shade}"/>
    <!-- boogspiegel achter -->
    <path d="M150 470 L150 300 A55 55 0 0 1 260 300 L260 470 Z" fill="${P.creamL}" stroke="${P.bronze}" stroke-width="3"/>
    <path d="M170 300 Q205 262 240 298" stroke="#fff" stroke-width="8" fill="none" opacity=".8" stroke-linecap="round"/>
    <!-- hoge vaas met tak -->
    <path d="M330 470 Q312 400 320 340 Q324 312 350 312 Q376 312 380 340 Q388 400 370 470 Z" fill="${P.clay}"/>
    <ellipse cx="350" cy="313" rx="16" ry="5" fill="${P.ink}" opacity=".8"/>
    <path d="M350 313 Q320 250 300 210" stroke="${P.ink}" stroke-width="2.5" fill="none"/>
    <path d="M350 313 Q380 240 400 200" stroke="${P.ink}" stroke-width="2.5" fill="none"/>
    <circle cx="300" cy="208" r="6" fill="${P.bronze}"/><circle cx="400" cy="198" r="6" fill="${P.sand}"/>
    <circle cx="318" cy="250" r="5" fill="${P.sand}"/><circle cx="378" cy="242" r="5" fill="${P.bronze}"/>
    <!-- geurkaars vooraan -->
    <rect x="408" y="418" width="52" height="52" rx="4" fill="#B9AB8C"/>
    <rect x="408" y="405" width="52" height="14" rx="3" fill="${P.ink}" opacity=".85"/>
    <line x1="434" y1="405" x2="434" y2="393" stroke="${P.ink}" stroke-width="2"/>
    <path d="M434 393 Q428 383 434 375 Q440 383 434 393" fill="${P.bronze}"/>
    <!-- boekenstapel -->
    <rect x="90" y="452" width="86" height="10" fill="${P.ink}" opacity=".85"/>
    <rect x="96" y="440" width="80" height="12" fill="${P.sand}"/>
    <rect x="92" y="428" width="78" height="12" fill="${P.bronze}" opacity=".8"/>
  </svg>`;
}
